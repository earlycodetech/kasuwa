...
export function Product() {
    return (
        <CustomSafeAreaView>
            <ScrollView>
                <Text style={styles.ProductName}>ADIDAS ORIGINALS +
                    KANYE WEST ANNOUNCE THE YEEZY BOOST 700 MAUVE</Text>
                ...
                <Text style="styles.description">The YEEZY BOOST 700 features a full-length drop in boost midsole, an upper composed of
                    mauve suede overlays and black premium leather with mesh underlays and green heel details. The shoe has a gum sole along
                    with reflective heel and Three Stripes.
                ...
                <View style={styles.gallery}>
                    ...
                    <Image style={styles.galleryImg} source={require('../assets/images/single-product/main.jpg')} />
                </View>
            </ScrollView>
        </CustomSafeAreaView>
    )
